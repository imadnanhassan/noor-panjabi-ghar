            ...
            <table className="w-full">
              <thead className="bg-(--admin-bg-light) text-(--admin-text-muted) text-[10px] md:text-xs uppercase tracking-wider">
                <tr>
                  ...
                  <th className="p-3 md:p-5 text-left">Payment</th>
                  ...
                  >
                    ...
                    <td className="p-3 md:p-5 hidden md:table-cell">
                      <div className="flex items-center gap-2">
                        <button
                          className="p-2 text-(--admin-text-muted) hover:text-(--admin-gold) transition-colors"
                          title="View Details"
                        >
                          <Eye size={16} />
                        </button>
                        {order.status !== "Cancelled" &&
                          order.status !== "Refunded" && (
                            <>
                              <button
                                className="p-2 text-(--admin-text-muted) hover:text-blue-500 transition-colors"
                                title="Update Status"
                              >
                                <CheckCircle size={16} />
                              </button>
                              {order.status !== "Delivered" && (
                                <button
                                  className="p-2 text-(--admin-text-muted) hover:text-rose-500 transition-colors"
                                  title="Cancel Order"
                                >
                                  <Ban size={16} />
                                </button>
                              ...
                              {(order.status === "Delivered" ||
                                ...
                                <button
                                  className="p-2 text-(--admin-text-muted) hover:text-orange-500 transition-colors"
