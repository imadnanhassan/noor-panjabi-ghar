...
export default function ColorManagementPage() {
  ...
  const colors = [
    {
      ...
      name: "Royal Blue",
      hexCode: "#1E40AF",
      description: "Deep blue color perfect for traditional wear",
      usageCount: 67,
      status: "Active",
    ...
    },
    {
      ...
      name: "Crimson Red",
      hexCode: "#DC2626",
      description: "Rich red shade for festive occasions",
      usageCount: 45,
      status: "Active",
    ...
    },
    {
      ...
      name: "Forest Green",
      hexCode: "#059669",
      description: "Deep green for elegant designs",
      usageCount: 34,
      status: "Active",
    ...
    },
    {
      ...
      name: "Golden Yellow",
      hexCode: "#D97706",
      description: "Warm gold tone for special collections",
      usageCount: 23,
      status: "Active",
    ...
    },
    {
      ...
      name: "Pure White",
      hexCode: "#FFFFFF",
      description: "Clean white for minimalist designs",
      usageCount: 56,
      status: "Active",
    ...
    },
    {
      ...
      name: "Charcoal Black",
      hexCode: "#1F2937",
      description: "Deep black for classic looks",
      usageCount: 78,
      status: "Active",
    ...
    },
    {
      ...
      hexCode: "#8B5CF6",
      description: "Soft purple for contemporary styles",
      usageCount: 0,
      status: "Inactive",
  ...
  const filteredColors = colors.filter((color) => {
    ...
    const matchesStatus = !filters.status || color.status === filters.status;

    let matchesUsage = true;
    if (filters.usage === "No Usage") {
      matchesUsage = color.usageCount === 0;
    } else if (filters.usage === "Low Usage") {
      matchesUsage = color.usageCount > 0 && color.usageCount < 30;
    } else if (filters.usage === "High Usage") {
      matchesUsage = color.usageCount >= 30;
    }
      ...
      <div className="max-w-[1600px] mx-auto p-4 md:p-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          >
            ...
            >
              Manage color variants for your product collection
            </motion.p>
          </motion.div>
          <Link href="/admin/store/variants/color/add">
            <motion.button
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-(--admin-bg-light) text-(--admin-text-muted) text-[10px] md:text-xs uppercase tracking-wider">
                <tr>
                  <th className="p-3 md:p-5 text-left">Color</th>
                  <th className="p-3 md:p-5 text-left">Hex Code</th>
              ...
              <tbody>
                {filteredColors.map((color) => (
                  <motion.tr
                    ...
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: 1.1 + color.id * 0.05 }}
                    whileHover={{
                  ...
                  >
                    <td className="p-3 md:p-5">
                      <div className="flex items-center gap-3">
                        <div
                          className="w-12 h-12 rounded-lg border-2 border-(--admin-border)"
