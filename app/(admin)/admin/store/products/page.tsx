...
export default function ProductsPage() {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    if (filters.priceRange) {
      ...
      if (filters.priceRange === "Under ₹1,000") {
        matchesPrice = price < 1000;
      } else if (filters.priceRange === "₹1,000 - ₹2,000") {
        matchesPrice = price >= 1000 && price <= 2000;
      } else if (filters.priceRange === "₹2,000 - ₹3,000") {
        matchesPrice = price >= 2000 && price <= 3000;
      } else if (filters.priceRange === "Above ₹3,000") {
      ...
      <div className="max-w-[1600px] mx-auto p-4 md:p-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          >
            ...
            >
              Manage your Punjabi traditional wear collection
            </motion.p>
          </motion.div>
          <motion.button
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="Above ₹3,000">Above ₹3,000</option>
                        </select>
                      </div>
                    </div>
                  </div>
                    ...
                    <td className="p-3 md:p-5">
                      <div className="flex items-center gap-2 md:gap-3">
                        <img
                          src={product.image}
                          alt={product.name}
                          className="w-10 h-10 md:w-12 md:h-12 rounded-lg object-cover bg-(--admin-bg-light)"
                        />
                        <div>
